...
class MapViewController: UIViewController, MKMapViewDelegate {
    ...
    private lazy var deleteButton: UIButton = {
        ...
        deleteButton.setTitle("Удалить все точки", for: .normal)
    ...
    func showAlert() {
        let alert = UIAlertController(title: "Ошибка", message: "Необходимо указать конечную точку маршрута", preferredStyle: .alert)
